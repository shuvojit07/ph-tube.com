...
// innet html div att for button
    buttonContainer.innerHTML = `
        <button id="btn-${item.category_id}" onclick="loadCategorieyVideos(${item.category_id})" class="btn category-btn">
        ${item.category}
        </button>
    `;
